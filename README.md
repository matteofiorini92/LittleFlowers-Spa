...
The goal of this website is to showcase them and allow customers to get to know the options offered, the staff of the SPA and get in touch to know availability and book treatments.
...
- Feature 3 - allows returning customers to check if the staff member who gave them the treatment previously is still working there, get their name and request the treatment with them again in case they liked it the first time
- Feature 4 - allows potential and returning customers to get in touch to check availablity, book or ask questions by filling a "contact us" form
